...
class MessagesArTranslationTest {
    ...
    fun `arabic translation differs from english for key`(key: String) {
        val en = SliderMessages.get(key, "en")
        val ar = SliderMessages.get(key, "ar")
        assertNotEquals(en, ar, "Key '$key' should be translated to Arabic, not a copy of English")
    }
}